========================================================================
    APLICACIÓN: practica_graficador Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación practica_graficador.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación practica_graficador.

practica_graficador.vcxproj
...
practica_graficador.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado practica_graficador.pch y un archivo de tipos precompilados llamado StdAfx.obj.
